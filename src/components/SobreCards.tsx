...
const fontes = [
  {
    nome: "IBGE SIDRA — PIB estadual, desemprego e população",
    href: "https://sidra.ibge.gov.br",
    cor: "verde",
  },
  {
    nome: "IBGE Geociências — malha vetorial dos estados",
    href: "https://www.ibge.gov.br/geociencias/downloads-geociencias.html",
    cor: "verde",
  },
  {
    nome: "TSE — referência histórica de mandatos",
    href: "https://dadosabertos.tse.jus.br",
    cor: "amarelo",
  },
  {
    nome: "Registros históricos públicos — mandatos curados manualmente",
    href: "https://www.tse.jus.br/eleicoes/eleicoes-anteriores",
    cor: "neutro",
  },
];

export function SobreCards() {
  return (
    <motion.div
    ...
    >
      ...
      >
        ...
        <p className="text-sm text-neutral-400">
          Democratizar o acesso à informação governamental através de visualizações claras e cruzamentos de dados históricos.
        </p>
      </motion.div>
      ...
      >
        ...
        <ul className="space-y-2">
          {fontes.map((f) => (
            <li key={f.nome}>
              <a href={f.href} target="_blank" rel="noopener noreferrer" className="flex items-center gap-2 text-sm text-neutral-400 hover:text-neutral-200 transition-colors duration-150">
                <span className="h-1 w-1 rounded-full shrink-0" style={{ backgroundColor: f.cor === "verde" ? "#009c3b" : f.cor === "amarelo" ? "#ffdf00" : "#52525b" }} />
                {f.nome}
      ...
      >
        ...
        <div className="flex items-center gap-2 mb-2">
          ...
          <a href="https://github.com/Husty-09" target="_blank" rel="noopener noreferrer" className="text-neutral-500 hover:text-neutral-200 transition-colors duration-150" aria-label="GitHub">
        ...
        <p className="text-sm text-neutral-400 leading-relaxed">
          Matheus — estudante apaixonado por cenários econômicos e história. O GovData-BR nasceu da vontade de unir o interesse em dados públicos com desenvolvimento web, criando uma ferramenta visual, simples e interativa para explorar a economia brasileira.
        </p>
      </motion.div>
    </motion.div>
  );
