        ...
        >
          ...
          >
            <div
              ...
              style={{ backgroundColor: "rgba(0,156,59,0.08)" }}
            />
            <div
          ...
          >
            ...
            <div
              ...
              style={{
                background:
                  "linear-gradient(135deg, rgba(255,223,0,0.05) 0%, transparent 60%)",
              }}
            />
            <h3
          ...
          >
            ...
            <div className="flex flex-wrap gap-2">
              {stack.map((tech) => (
                <span
                  key={tech}
                  className="px-2 py-0.5 rounded-md text-xs border border-white/8 text-neutral-400 bg-white/3"
                >
                  {tech}
                </span>
              ))}
          ...
          >
            ...
            <p className="text-sm text-neutral-400 leading-relaxed">
              ...
              O GovData-BR nasceu da vontade de unir o interesse em dados
              públicos com desenvolvimento web, criando uma ferramenta visual,
              simples e interativa para explorar a economia brasileira.
            </p>
          </motion.div>
        </motion.div>
